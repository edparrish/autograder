...
class TestCompareSQL extends TestCase {
    ...
    */
     ...
     */
    function runTest(&$tr, $sectionName) {
        require("C:/Courses/tools/autograde5/dbconvars.php");
...
class TestCompileCPP extends TestCase {
     ...
     */
    function runTest(&$tr, $sectionName) {
        $errout = ERROUT;  // errout collects info o Windows
        ...
        $cmd = $this->cmd;
        if ($cmd === '') {
            $cmd = "g++ -Wall -Wextra -std=c++11 -o $base $testBase.cpp";
        }
...
function unitTestStyleCPP() {
    require_once 'C:/Courses/tools/autograde5/Properties.php';
    require_once 'C:/Courses/tools/autograde5/testresult.php';
